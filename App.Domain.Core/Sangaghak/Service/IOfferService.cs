...
namespace App.Domain.Core.Sangaghak.Service
{
    public interface IOfferService
    {
        ...
        public Task<OfferDTO> GetAcceptedOfferByRequestId(int RequestId, CancellationToken cancellationToken);
        public Task<List<int>> GetListOfExpertRequestIds(int expertId, CancellationToken cancellationToken);
